<?php 
	...
	if(empty($_REQUEST['id'])){
		...
		$query_datos = mysqli_query($conection,"SELECT d.iddatos, d.num_reporte, d.marca, d.modelo, d.no_serie, d.descripcion, (d.tipo_registro) AS idtipo_registro, (t.tipo_registro) AS tipo_registro, (d.motivo) AS idmotivo, (m.motivo) AS motivo, d.departamento, d.ubicacion_fisica, d.ubicacion_sistema, d.dateadd 
												FROM datos d 
												INNER JOIN motivo m 
